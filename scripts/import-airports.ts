/**
 * Import OurAirports data into Supabase
 *
 * This script downloads airport and runway data from OurAirports.com
 * and imports it into the Supabase database.
 *
 * Prerequisites:
 * 1. Download CSVs from https://ourairports.com/data/
 * 2. Place them in ./data/ directory:
 *    - airports.csv
 *    - runways.csv
 * 3. Set SUPABASE_SERVICE_KEY in .env.local
 *
 * Usage:
